 ...
 */
export declare class CfnOrganizationTelemetryRule extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
    /**
 ...
 */
export declare class CfnTelemetryRule extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
